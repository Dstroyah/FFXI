...
function init_gear_sets()
	...
	sets.idle = {ammo="White tathlum",
									...
									back="Cichol's Mantle",waist="ioskeha Belt",legs="Sulevi. Cuisses +1",feet="Hermes' Sandals"}

	sets.idle.Town = {ammo="White tathlum",
									head="Valorous Mask",neck="Twilight Torque",ear1="steelflash Earring",ear2="bladeborn Earring",
									body="Sulevia's Plate. +1",hands="Sulev. Gauntlets +2",ring1="warp Ring",ring2="orvail ring",
									back="Cichol's Mantle",waist="ioskeha Belt",legs="Sulevi. Cuisses +1",feet="Hermes' Sandals"}
	...
	sets.engaged.PDT = set_combine(sets.engaged, {head="Sulevia's Mask +1",neck="Twilight Torque", back="Mollusca mantle"} )
