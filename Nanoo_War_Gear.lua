...
--  sets.passive.Twilight = {head="Twilight Helm",body="Twilight Mail"}
    ...
    sets.precast.WS['Savage Blade'] = set_combine(sets.precast.WS, {
		...
		head="Agoge Mask +3",
		body="Pumm. Lorica +3",
		hands={ name="Odyssean Gauntlets", augments={'Attack+17','Weapon skill damage +4%','STR+5','Accuracy+2',}},
		legs={ name="Odyssean Cuisses", augments={'Rng.Acc.+16','Attack+25','Weapon skill damage +6%','Accuracy+6 Attack+6','Mag. Acc.+14 "Mag.Atk.Bns."+14',}},
	...
	sets.precast.WS['Sonic Thrust'] = set_combine(sets.precast.WS, {
		...
		right_ring="Niqmaddu Ring",
		back={ name="Cichol's Mantle", augments={'VIT+20','Accuracy+20 Attack+20','VIT+8','Weapon skill damage +10%',}},})
    sets.precast.WS['Sonic Thrust'].SomeAcc = set_combine(sets.precast.WS.SomeAcc, {})
...
-- Ragnarok melee sets
	...
	sets.weapons.ProcSword = {main="Naegling",sub="Blurred Shield"}
