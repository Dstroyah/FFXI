...
function init_gear_sets()
        ...
        sets.precast.JA['Velocity Shot'] = {body="Amini Caban +1",back={ name="Belenus's Cape", augments={'AGI+20','Rng.Acc.+20 Rng.Atk.+20','"Store TP"+10',}},}
    ...
    back={ name="Belenus's Cape", augments={'AGI+20','Rng.Acc.+20 Rng.Atk.+20','Rng.Acc.+6','"Store TP"+10',}},
        })
    ...
    back={ name="Belenus's Cape", augments={'AGI+20','Rng.Acc.+20 Rng.Atk.+20','Rng.Acc.+10','"Store TP"+10',}},
        ...
        sets.precast.RA = {
            ...
            back={ name="Belenus's Cape", augments={'"Snapshot"+10',}}, -- 2% VS / 10 snap (for now)
    ...
    hands="Meg. Gloves +2",
    legs="Arcadian braccae +3",
    feet={ name="Herculean Boots", augments={'Rng.Atk.+28','Weapon skill damage +3%','AGI+14','Rng.Acc.+9',}},
    neck="Fotia Gorget",
    waist="Fotia Belt",
    ...
    neck="Baetyl Pendant",
    waist="Hachirin-no-obi",--Hachirin-no-obi --Eschan Stone
