function get_sets()
	...
	function file_unload()
		...
		sets.Idle.Town = { ammo="Staunch Tathlum +1", head="Ken. Jinpachi +1", body="Ken. Samue +1",
								hands={ name="Valorous Mitts", augments={'STR+5','Pet: INT+4','Weapon skill damage +8%','Accuracy+8 Attack+8',}},
								legs="Ken. Hakama +1", feet={ name="Ryuo Sune-Ate +1", augments={'HP+65','"Store TP"+5','"Subtle Blow"+8',}},
								neck="Sam. Nodowa +1", waist="Reiki Yotai", left_ear="Thrud Earring", right_ear="Telos Earring",
								left_ring="Niqmaddu Ring", right_ring="Gelatinous Ring +1",
		...
		sets.Fudo.Accuracy = {range="Cibitshavore",ammo="Tulfaire arrow",
							  ...
							  body="Phorcys korazin",hands="Phorcys mitts",ring1="Kerieyh Ring",ring2="Rajas ring",
		...
		sets.Kaiten.Accuracy = {range="Cibitshavore",ammo="Tulfaire arrow",
							    ...
							    body="Phorcys korazin",hands="Phorcys mitts",ring1="Vulcan's ring",ring2="Kerieyh Ring",
