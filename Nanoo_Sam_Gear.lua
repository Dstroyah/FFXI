...
function init_gear_sets()
    ...
    sets.precast.JA.Meditate = {head="Wakido Kabuto +1",hands="Sakonji Kote +2",back="Smertrio's Mantle"}
    sets.precast.JA['Warding Circle'] = {head="Wakido Kabuto +1"}
    sets.precast.JA['Blade Bash'] = {hands="Sakonji Kote +1"}
	sets.precast.JA['Sekkanoki'] = {hands="Kasuga Kote +1"}
	sets.precast.JA['Sengikori'] = {feet="Kas. Sune-Ate +1"}
	sets.precast.JA['Meikyo'] = {feet="Sakonji sune-ate"}
    ...
    sets.precast.WS = {
			ammo="Knobkierrie",
			head={ name="Valorous Mask", augments={'Mag. Acc.+5 "Mag.Atk.Bns."+5','STR+10','Weapon skill damage +7%',}},
			body="Sakonji Domaru +3",
			hands={ name="Valorous Mitts", augments={'Pet: Haste+1','Magic burst dmg.+5%','Weapon skill damage +10%',}},
			legs="Wakido haidate +3",
			feet={ name="Valorous Greaves", augments={'VIT+2','Attack+10','Weapon skill damage +8%','Accuracy+7 Attack+7',}},
    ...
    sets.precast.WS['Tachi: Jinpu'] = {ammo="Knobkierrie",
			head={ name="Valorous Mask", augments={'"Mag.Atk.Bns."+25','"Dual Wield"+4','Mag. Acc.+16 "Mag.Atk.Bns."+16',}},
