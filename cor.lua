...
function init_gear_sets()
    ...
    sets.precast.WS['Savage Blade'] = set_combine(sets.precast.WS, {
		...
		waist="Prosilio Belt",
		legs={ name="Herculean Trousers", augments={'Accuracy+12 Attack+12','Weapon skill damage +5%','DEX+6','Attack+5',}},
		feet={ name="Herculean Boots", augments={'Accuracy+18 Attack+18','Weapon skill damage +5%','AGI+6','Accuracy+6','Attack+2',}}
        })
