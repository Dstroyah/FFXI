...
function init_gear_sets()
    ...
    body="Nzingha Cuirass",
    hands={ name="Valorous Mitts", augments={'STR+5','Pet: INT+4','Weapon skill damage +8%','Accuracy+8 Attack+8',}},
    legs={ name="Odyssean Cuisses", augments={'Pet: DEX+1','VIT+3','Weapon skill damage +6%','Accuracy+2 Attack+2',}},
    feet="Sulev. Leggings +2",
    neck="Fotia Gorget",
    waist="Sailfi Belt +1",
    left_ear="Thrud Earring",
    ...
    sets.precast.WS.Stardiver = set_combine(sets.precast.WS, {
     ...
     sets.engaged = {
         ammo="Ginsen", head="Flam. Zucchetto +2",
					body={ name="Valorous Mail", augments={'Accuracy+22 Attack+22','"Store TP"+6','AGI+9','Accuracy+9',}},
					hands="Sulev. Gauntlets +2",
					legs={ name="Odyssean Cuisses", augments={'Accuracy+7 Attack+7','"Store TP"+5','VIT+8','Accuracy+14','Attack+13',}},
					feet="Flam. Gambieras +2", neck="Lissome Necklace", waist="Sailfi Belt +1", left_ear="Telos Earring", right_ear="Brutal Earring",
					left_ring="Flamma Ring", right_ring="Niqmaddu Ring",
					back={ name="Cichol's Mantle", augments={'DEX+20','Accuracy+20 Attack+20','Accuracy+4','"Dbl.Atk."+10','Phys. dmg. taken-10%',}},
     }
