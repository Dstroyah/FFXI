...
function user_setup()
    ...
    state.Gun = M{['description']='Compensator', 'Death Penalty', 'Fomalhaut', 'Ataktos'}--, 'Armageddon'
	...
	tpback = { name="Camulus's Mantle", augments={'AGI+20','Rng.Acc.+20 Rng.Atk.+20','"Store TP"+10','Phys. dmg. taken-10%',}}
	...
	Snback = { name="Camulus's Mantle", augments={'"Snapshot"+10',}}
	
    gear.RAbullet = "Iron Bullet"
    gear.WSbullet = "Iron Bullet"
    gear.MAbullet = "Iron Bullet"
    gear.QDbullet = "Iron Bullet"
...
function init_gear_sets()
    ...
    sets.precast.RA.Flurry2 = set_combine(sets.precast.RA.Flurry1, {
        head="Navarch's Tricorne +2", --0/14
    ...
    range={ name="Holliday", augments={'STR+17','Rng.Acc.+6','Rng.Atk.+23','DMG:+5',}},
    head="Meghanada Visor +1",
    body="Laksa. Frac +2",
    hands="Meg. Gloves +2",
    legs={ name="Herculean Trousers", augments={'Attack+16','Weapon skill damage +5%','STR+8',}},
    feet={ name="Herculean Boots", augments={'Attack+22','Weapon skill damage +4%','DEX+5',}},
    ...
    back={ name="Camulus's Mantle", augments={'AGI+10','Rng.Acc.+10 Rng.Atk.+10','Weapon skill damage +10%',}},
        })
    ...
    range={ name="Holliday", augments={'STR+17','Rng.Acc.+6','Rng.Atk.+23','DMG:+5',}},
    head={ name="Herculean Helm", augments={'"Mag.Atk.Bns."+10','STR+12','Weapon skill damage +8%','Mag. Acc.+2 "Mag.Atk.Bns."+2',}},
    body="Laksa. Frac +2",
    hands="Meg. Gloves +2",
    legs={ name="Herculean Trousers", augments={'Attack+16','Weapon skill damage +5%','STR+8',}},
    feet={ name="Herculean Boots", augments={'Attack+22','Weapon skill damage +4%','DEX+5',}},
    ...
    feet={ name="Herculean Boots", augments={'"Triple Atk."+4','DEX+9','Attack+14',}},
    neck="Commodore Charm",
    waist="Kentarch Belt",
    left_ear="Mache Earring",
    ...
    body="Rawhide Vest",
    hands={ name="Adhemar Wristbands", augments={'DEX+10','AGI+10','Accuracy+15',}},
    legs={ name="Herculean Trousers", augments={'Attack+16','"Triple Atk."+2','STR+10','Accuracy+6',}},
    feet={ name="Herculean Boots", augments={'"Triple Atk."+4','DEX+9','Attack+14',}},
